...
# Also ensure spaCy models are accessible
if [ -d "/usr/local/lib/python3.10/site-packages/en_core_web_sm" ]; then
    chmod -R 755 /usr/local/lib/python3.10/site-packages/en_core_web_sm
fi
