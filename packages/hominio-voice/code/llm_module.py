...
REDPILL_BASE_URL = os.getenv("LLM_BASE_URL", "https://api.redpill.ai/v1")

# Legacy OpenAI and other backends
...
class LLM:
    ...
    def __init__(
        ...
        self.effective_openai_base_url = self._base_url or REDPILL_BASE_URL if self.backend == "openai" else None
